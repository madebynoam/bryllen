      ...
      <div style={{
        ...
        <Sidebar>
          ...
          <p style={{
            ...
            Canvai adds a spatial layer to AI design. Instead of one result at a time in a chat, you get an infinite, zoomable canvas where every generation lives as a frame.
          </p>
          <p style={{
        ...
        <Main>
          ...
          <section style={{ marginBottom: 80 }}>
            <div {...phB} style={{
              ...
              <img src={canvasWide} alt="Canvai canvas" style={{ width: '100%', display: 'block' }} />
            </div>
            <p style={{
              fontFamily: mono, fontSize: 10, color: C.textTer, marginTop: 12,
              letterSpacing: '0.04em',
            }}>Fig. 1 — Five design directions on the Canvai canvas, viewed simultaneously</p>
          </section>
