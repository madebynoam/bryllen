...
export const darkTheme: Record<string, string> = {
  ...
  '--bryllen-txt-pri':      'oklch(0.920 0.005 240)',
  '--bryllen-txt-sec':      'oklch(0.720 0.003 240)',
  '--bryllen-txt-muted':    'oklch(0.580 0.002 240)',
  '--bryllen-txt-ter':      'oklch(0.480 0.002 240)',
